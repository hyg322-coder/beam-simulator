...
# --- 1. データベース ---
material_db = {
    "杉 (E70)": {"E": 7000, "fb": 15.0/1.5, "fs": 1.2/1.5},
...
ax_s.plot(x_vals, s_diagram, color="darkorange", label="S-Diagram (N)")
ax_s.set_ylabel("Shear (N)")
ax_s.grid(True, linestyle="--", alpha=0.5)

# M図 (曲げモーメント)
ax_m.fill_between(x_vals, m_diagram, 0, color="green", alpha=0.3)
ax_m.plot(x_vals, m_diagram, color="forestgreen", label="M-Diagram (N･mm)")
