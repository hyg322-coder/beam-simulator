...
ax_s.set_ylim(lim_s, -lim_s) # 上をプラスに固定
decorate(ax_s, "S", "kN")
...
ax_d.invert_yaxis()
ax_d.set_ylim(60, -5)
ax_d.text(L/2, delta_max, f"d={delta_max:.1f}", color="blue", ha="center", va
